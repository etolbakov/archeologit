...
use crate::git::{
    checkout_last_commit, get_branch_name, get_commit_ids, move_git_pointer, repo, show_commit_info,
};
...
fn main() {
    ...
    let help_table = vec![
        vec![
            "b <step>".cell(),
            "⏭  go to previous <step> commits; <step> is 1 by default"
                .cell()
                .justify(Justify::Left),
        ],
        vec![
            "n <step>".cell(),
            "⏮  go to next <step> commits; <step> is 1 by default"
                .cell()
                .justify(Justify::Left),
        ],
        vec![
            "i".cell(),
            "🔎 get information about current commit: file path and status"
                .cell()
                .justify(Justify::Left),
        ],
        vec![
